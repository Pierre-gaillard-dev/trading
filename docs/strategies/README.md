...
> Le **sizing** (quelle quantité acheter/vendre) n'est PAS dans la stratégie : la stratégie dit *quoi* faire (BUY/SELL/HOLD), le `TradingBot` + une politique de sizing décident *combien*. Cela garde les stratégies pures et testables isolément.
