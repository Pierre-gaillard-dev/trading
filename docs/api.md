...
Réponse :
```json
[{ "key": "rsi", "name": "RSI", "family": "mean_reversion",
   "params": [{ "name": "period", "type": "int", "default": 14, "min": 2 },
...
```json
{ "name": "RSI sur BTC", "baseCurrency": "USDT",
  "initialCash": "10000.00", "feeRate": "0.001", "slippageBps": 5 }
```
...
`POST /api/bots` (corps) :
```json
{ "portfolioId": "pf_123", "symbol": "BTCUSDT", "interval": "1m",
  "strategyKey": "rsi", "params": { "period": 14, "oversold": 30, "overbought": 70 },
